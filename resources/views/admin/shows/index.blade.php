            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3><strong>Shows</strong> Listing </h3>
                    ...
                    @endif
                    <div class="card-body">
                        <a href="{{ route('admin.shows.create') }}" class="btn btn-primary"> Add Shows</a>
                        <br><br>
                                    ...
                                    @if (count($shows) > 0)
                                        ...
                                        @foreach ($shows as $data)
                                            ...
                                            <tr>
                                                ...
                                                <td> <img
                                                        src="{{ asset('uploads/shows_images/' . $data->featured_image) }}"
                                                        height="100px" width="100px" alt="{{ $data->featured_image }}">
                                                </td>
                                                <td> {{ $data->cat_title }}</td>
                                                <td> {{ Str::limit($data->description, 20) }}</td>
                                                <td> {{ $data->youtube_video_url }}</td>
                                                <td>
                                                    @if ($data->status == 1)
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.shows.edit', $data->id) }}"
                                                        class="btn btn-primary">
                                                        <i class="fas fa-edit" style="font-size:15px;"></i>
                                                    </a>
                                                    &nbsp;&nbsp;
                                                    <a href="{{ route('admin.shows.delete', $data->id) }}"
