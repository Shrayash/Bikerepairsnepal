...
@section('content')
    ...
    <div class="card">
        ...
        @endif
        <div class="card-body">
            <form action="{{ route('admin.shows.update', $shows->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label style="color:black; font-size:1rem">Title<span
                            style="color:red;font-size:15px;">&nbsp;*</span></label>
                    <input type="text" name="show_title" value="{{ $shows->show_title }}" class="form-control" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control category_select" name="category_id" id="exampleFormControlSelect1">
                        ...
                        @foreach ($showsCategory as $catData)
                            @if ($shows->category_id == $catData->id)
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" rows="5" cols="40"
                        class="form-control tinymce-editor">{{ $shows->description }}</textarea>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <br><br>
                            <img id="blah" src="{{ asset('uploads/shows_images/' . $shows->featured_image) }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="radio" name="status" id="exampleRadios1" value="1"
                                    {{ $shows->status == '1' ? 'checked' : '' }} checked>
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="radio" name="status" id="exampleRadios2" value="0"
                                    {{ $shows->status == '0' ? 'checked' : '' }} checked>
