            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3><strong>News</strong> Categories </h3>
                    ...
                    @endif
                    <div class="card-body">
                        <a href="{{ url('admin/add/news/category') }}" class="btn btn-primary"> Add News Category</a>
                        <br><br>
                                        ...
                                        @foreach ($categories as $category)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    &nbsp;&nbsp;
                                                    <a href="{{ route('admin.news.category.delete', $category->id) }}"
