...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.news.category.updates', $editCategory->id) }}" method="POST"
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="category_title" value="{{ $editCategory->category_title }}"
