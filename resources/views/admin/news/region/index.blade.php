            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3><strong>News</strong> Regions </h3>
                    ...
                    @endif
                    <div class="card-body">
                        <a href="{{ route('admin.news.region.create') }}" class="btn btn-primary"> Add News
                            Reason</a>
                        <br><br>
                                    ...
                                    @if (count($regions) > 0)
                                        ...
                                        @foreach ($regions as $region)
                                            ...
                                            <tr>
                                                ...
                                                <td> <span class="badge badge-primary">{{ $region->slug }} </span></td>
                                                <td>
                                                    @if ($region->status == 1)
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.news.region.edit', $region->id) }}"
                                                        class="btn btn-primary">
                                                        <i class="fas fa-edit" style="font-size:15px;"></i>
                                                    </a>
                                                    &nbsp;&nbsp;
                                                    <a href="{{ route('admin.news.region.delete', $region->id) }}"
