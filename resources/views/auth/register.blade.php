        ...
        <div class="row">
            <div class="col-lg-4 col-sm-12">
                <form class="card auth_form" method="POST" action="{{ route('register') }}>
                    <div class="header">
                        <img class="logo" src="{{ asset('assets') }}/images/favicon.png" alt="" style="width:10rem;">
                        <h5>Sign Up</h5>
                        <span>Register to Glocal Platform</span>
                    </div>
                    <div class="body">
                        ...
                        <div class="signin_with mt-3">
                           Already a member? <a class="link" href="{{url('login')}}">Sign In Instead.</a>
                        </div>
                    </div>
                </form>
            ...
            <div class="col-lg-8 col-sm-12">
                <div class="card">
                    <img src="{{asset('dashboard')}}/images/signup.svg" alt="Sign Up" />
                </div>
            </div>
        </div>
    </div>
